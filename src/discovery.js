...
export const SETTING_DEFINITIONS = [
  ...
  {id:'zombie-apocalypse',label:'Zombie apocalypse',aliases:['zombie apocalypse','зомби апокалипсис'],any:[/zombie.?(?:apocal|apacol)/i,/зомби.?апокалип/i,/\bzombies?\b/i,/\bundead\b/i,/\bhorde\b/i]},
  ...
  {id:'fantasy',label:'Fantasy',aliases:['фэнтези'],any:[/\bfantasy\b/i,/\bфэнтези\b/i,/\bmagic kingdom\b/i,/\b(?:hogwarts|horcrux|mudblood|demigods?|greek gods?|son of hades|demon (?:that )?became a god)\b/i]},
  {id:'sci-fi',label:'Sci-Fi',aliases:['science fiction','научная фантастика'],any:[/\bsci[- ]?fi\b/i,/science fiction/i,/научн(?:ая|ой) фантаст/i,/\bintergalactic\b/i,/\b(?:controlled utopia|genetic material.{0,50}(?:cure|disease|control people))\b/i]},
  {id:'dystopia',label:'Dystopia',aliases:['dystopian world','антиутопия'],any:[/\bdystopi(?:a|an)\b/i,/\bcontrolled utopia\b/i,/\bworld where .{0,80}(?:have no rights|are (?:owned|bought|sold)|is property)\b/i,/\bантиутоп/i]},
  {id:'cyberpunk',label:'Cyberpunk',aliases:['киберпанк'],any:[/\bcyberpunk\b/i,/\bкиберпанк\b/i,/neon dystopia/i]},
  {id:'supernatural',label:'Supernatural',aliases:['urban fantasy','сверхъестественное'],any:[/\bsupernatural\b/i,/urban fantasy/i,/сверхъестествен/i,/\bparanormal\b/i,/\b(?:rougarou|werewolf|vampire|reincarnation|immortal heart|mystical world)\b/i]},
  ...
  {id:'slice-of-life',label:'Everyday',aliases:['slice of life','everyday','modern day','повседневность','современность'],any:[/\bslice of life\b/i,/\b(?:modern[- ]day|modern time|quiet suburban home)\b/i,/\b(?:boyfriend|girlfriend|husband|wife|fianc(?:e|é|ée)|ex[- ]?(?:boyfriend|girlfriend|husband|wife|bf)|best friend|coworker|boss|neighbor|roommate|tenant|single (?:dad|mom|father|mother)|office|workplace|apartment|dating app|vacation|landlord|streamer|investment consultant|construction company|bachelor party|wedding|summer (?:fling|romance)|bdsm club|new at the firm|business deal|bully|senator)\b/i,/\b(?:парень|девушка|муж|жена|жених|невеста|бывш(?:ий|ая)|лучш(?:ий|ая) друг|коллега|начальник|сосед|соседка|сожитель|офис|квартира|повседневн|современн|стример|арендодатель|свадьба)\b/i]},
