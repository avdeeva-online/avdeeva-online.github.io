(()=>{
  ...
  function addStyles(){
    ...
    const s=document.createElement('style');s.dataset.hubCategoryFilters='1';s.textContent=`
      ...
      #hubResourceModal .hub-theme-modal .hub-modal-head{grid-template-columns:minmax(0,1fr) auto;gap:14px}
