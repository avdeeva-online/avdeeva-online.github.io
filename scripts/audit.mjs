...
for(const marker of ['function toggleDrawer()','catalogToggle.onclick=toggleDrawer','setAttribute("aria-expanded","true")','setAttribute("aria-expanded","false")'])fail(publicApp.includes(marker),`public/app.js: catalog button toggle contract missing ${marker}`);
...
for(const marker of ['app.js?v=20260920-catalog-toggle1','catalog-api.js?v=20260919-render-boot1'])fail(charactersHtml.includes(marker),`public/characters.html: hashtag cache-bust missing ${marker}`);
...
fail(publicCharacters.includes('app.js?v=20260920-catalog-toggle1'),'public/characters.html: public app cache-bust missing');
