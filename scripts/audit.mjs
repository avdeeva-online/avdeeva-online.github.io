...
for(const marker of ['app.js?v=20260919-filter-pass1','catalog-api.js?v=20260919-render-boot1'])fail(charactersHtml.includes(marker),`public/characters.html: hashtag cache-bust missing ${marker}`);
...
fail(publicCharacters.includes('app.js?v=20260919-filter-pass1'),'public/characters.html: public app cache-bust missing');
