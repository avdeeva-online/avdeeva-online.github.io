(()=>{
  ...
  function addStyles(){
    ...
    const s=document.createElement('style');s.dataset.hubCategoryFilters='1';s.textContent=`
      ...
      /* THEME modal: same structure regardless of missing tags, links or file count. */
      #hubResourceModal .hub-modal-panel.hub-theme-modal{width:min(620px,calc(100vw - 28px));height:auto!important;max-height:88vh;min-height:0}
      #hubResourceModal .hub-theme-modal #hubModalContent{height:auto!important;max-height:88vh}
      ...
      #hubResourceModal .hub-theme-modal .hub-modal-body{padding:14px 18px 15px;flex:0 1 auto;overflow:hidden}
      #hubResourceModal .hub-theme-modal .hub-modal-head{display:grid;grid-template-columns:1fr;gap:9px;align-items:start}
      ...
      #hubResourceModal .hub-theme-modal .hub-modal-tabs{margin-top:9px;padding-top:9px}
      #hubResourceModal .hub-theme-modal .hub-modal-tabs:before{top:10px}
      #hubResourceModal .hub-theme-modal .hub-tab[data-tab="extras"]{color:#9b9f7c}
      #hubResourceModal .hub-theme-modal .hub-tab[data-tab="extras"].active{color:#eadfbd}
      #hubResourceModal .hub-theme-modal .hub-tab-pane.active{flex:0 1 auto;max-height:min(330px,42vh);overflow-y:auto}
